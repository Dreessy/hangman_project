...
def default_menu(game_data)
  ...
  while (cycle)
    ...
    when "4"
      system("clear")
      puts "Project created by Dreessy and Zaibas1220"
      puts "Special thanks to:"
      puts "Vanni96 Help in fixing bugs, and checking the code"
      puts "Raffaella Cirillo for help in translating the English version"
      puts "Sabrina Mariniello for help in transliting the Dutch version"
...
def italian_menu(game_data)
  ...
  while (cycle)
    ...
    when "4"
      system("clear")
      puts "Progetto creato da Dreessy e Zaibas1220"
      puts "Ringraziamenti speciali a:"
      puts "Vanni96 aiuto nella correzione dei bug e aiuto nel codice."
      puts "Raffaella Cirillo aiuto per la traduzione nella versione inglese"
      puts "Sabrina Mariniello aiuto per la traduzione nella versione tedesca"
